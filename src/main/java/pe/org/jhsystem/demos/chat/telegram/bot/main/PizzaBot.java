package pe.org.jhsystem.demos.chat.telegram.bot.main;
...
import pe.org.jhsystem.demos.chat.telegram.bot.handlers.ResponseHandler;
...
public class PizzaBot extends AbilityBot {
    ...
    public PizzaBot(Environment environment) {
        super(environment.getProperty("BOT_TOKEN"), "JHSystemsDemoBot");
